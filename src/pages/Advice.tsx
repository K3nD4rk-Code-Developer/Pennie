        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div>
                <p className="text-gray-600 text-sm font-medium">Emergency Fund</p>
                <p className="text-2xl font-bold text-blue-600">{financialHealth.emergencyFundMonths.toFixed(1)} months</p>
              </div>
            ...
            <div className="text-sm text-gray-600">
              {financialHealth.emergencyFundMonths < 3 ? 'Below recommended' : 
               financialHealth.emergencyFundMonths < 6 ? 'Good progress' : 'Excellent!'}
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{financialHealth.savingsRate.toFixed(1)}%</p>
              </div>
            ...
            <div className="text-sm text-gray-600">
              {financialHealth.savingsRate < 10 ? 'Needs improvement' :
               financialHealth.savingsRate < 20 ? 'Good, aim for 20%' : 'Excellent!'}
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">{formatCurrency(financialHealth.netWorth)}</p>
              </div>
            ...
            <div className="text-sm text-gray-600">
              {financialHealth.netWorth > 0 ? 'Positive net worth' : 'Focus on debt payoff'}
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div>
                <p className="text-gray-600 text-sm font-medium">Debt Balance</p>
                <p className="text-2xl font-bold text-red-600">{formatCurrency(financialHealth.debtBalance)}</p>
              </div>
            ...
            <div className="text-sm text-gray-600">
              {financialHealth.debtBalance === 0 ? 'Debt free!' : 'Focus on payoff strategy'}
            </div>
          </div>
        </div>
